...
1.basic information
1.1 Title:\n
1.2 The last name of the first author:\n
1.3 Publication year (only the year):\n
1.4 inclusion criteria for participants:\n
1.5 number of participants at randomization:\n
1.6 Intervention:\n
1.7 Control:\n
1.8 Outcomes and measurement times:\n
1.9 adverse events:\n
1.10 Foundation and funding:\n
1.11 Conflict of interest:\n
1.12 Registration or protocol:\n
1.13 Limitation:\n

2.quality assessment
2.1 Randomization (e.g.use of random sequence table, computer-generated, telephone-based, etc.):\n
2.2 concealment of randomization (e.g. use of telephone-based, web-based, pharmacy-controlled, envelope, box, card, etc.):\n
2.3 Implementation of randomization (Who generated the random allocation sequence, who enrolled participants, and who assigned participants to interventions):\n
2.4 Blinding details (use of placebo or other strategy to blind the patients or researcher) or open-label:\n
2.5 dropout (number of participants and reason):\n
2.6 fill in the missing outcome (ITT, per-protocol analysis, as-treated analysis):\n

3.characteristics at baseline for each group
3.1 Ratio of males to females:\n
3.2 Age:\n
3.3 Course of disease:\n
3.4 whether balanced or comparable:\n

4.information for reporting quality assessment
4.1 Study design:\n
4.2 Country, settings and locations:\n
4.3 Determination of sample size:\n
4.4 Statistical methods:\n
4.5 Participant flow (For each group, the numbers of participants at each trail period):\n
4.6 Recruitment period:\n
4.7 Follow-up:\n
4.8 Ancillary analyses (such as subgroup analyses and adjusted analyses):\n
'''

#rct
task3_info = '''
1.Basic information
1.1 inclusion criteria for participants:\n
1.2 number of participants at randomization:\n
1.3 Intervention:\n
1.4 Control:\n
1.5 Outcomes and measurement times:\n
1.6 adverse events:\n
1.7 Study design:\n
1.8 Limitation:\n
1.9 Country, settings and locations:\n 
1.10 Recruitment period:\n
1.11 Follow-up:\n
1.12 dropout (number of participants and reason):\n

2.Characteristics at baseline for each group
2.1 Age:\n
2.2 whether balanced or comparable:\n
'''
...
async def model_process(p_index,batch,new_file_folder_path,error_log_folder_path):
    ...
    for _pdf_path in pdf_list:
        ...
        try:
            ...
            print('file:',_pdf_path,'ids:',id1,id2,id3)
            #
            error_dic = {}
            error_dic['file_name'] = _pdf_path
...
if __name__ == '__main__':
    ...
    orig_data_folder = '/root/qwen-long/english/data_process_09_en_q1_2024_0812/countdata/dedup.txt'
    process_type = 2
